...
- **Title**: Professor, School of Computer and Information Sciences
- **Email**: Salman@uohyd.ac.in
- **Office**: N-110, SCIS, University of Hyderabad
- **Specialization**: Software Engineering, Software Quality, Testing
...
*Add RAs, interns, and visiting researchers*

| Name | Role | Period |
|------|------|--------|
| Name | Research Associate | 2024-2025 |
...
*Add graduated PhD students with current positions*

| Name | Graduation Year | Thesis Title | Current Position |
|------|-----------------|--------------|-------------------|
| Alumni Name 1 | 2023 | Research Title | Company/University |

### MS Alumni

*Add graduated MS students*

| Name | Graduation Year | Thesis Title | Current Position |
|------|-----------------|--------------|-------------------|
| Alumni Name 1 | 2024 | Project Title | Company/University |

---

## Visiting Scholars

*Add visiting researchers and collaborators*
